function ContactSection({ brownBg }) {
  return (
    <footer
      data-scroll
      data-scroll-section
    ...
    >
      <div className="text-[8vw] tracking-normal leading-[1.1] font-bold text-left font-SchnyderL w-full h-full flex flex-col justify-center place-items-center ">
        ...
        <div className="flex justify-between w-screen items-baseline px-[6vw] py-[1vw] place-items-center">
